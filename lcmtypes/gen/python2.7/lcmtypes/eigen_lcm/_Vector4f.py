...
class Vector4f(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(Vector4f._CACHED_STRUCT_0.pack(*self.data[:4]))

    @staticmethod
    def decode(data):
        # type: (T.Union[bytes, T.BinaryIO]) -> Vector4f
    ...
    @staticmethod
    def _decode_one(buf):
        # type: (T.BinaryIO) -> Vector4f
        self = Vector4f(_skip_initialize=True)
        self.data = list(Vector4f._CACHED_STRUCT_0.unpack(buf.read(16)))
        return self
    ...
    def deepcopy(self, **kwargs):
        ...
        for key in kwargs:
            if not hasattr(result, key):
                raise KeyError("Type Vector4f does not have attribute: " + str(key))
