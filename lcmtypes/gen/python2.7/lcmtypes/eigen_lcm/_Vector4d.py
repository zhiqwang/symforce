...
class Vector4d(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(Vector4d._CACHED_STRUCT_0.pack(*self.data[:4]))

    @staticmethod
    def decode(data):
        # type: (T.Union[bytes, T.BinaryIO]) -> Vector4d
    ...
    @staticmethod
    def _decode_one(buf):
        # type: (T.BinaryIO) -> Vector4d
        self = Vector4d(_skip_initialize=True)
        self.data = list(Vector4d._CACHED_STRUCT_0.unpack(buf.read(32)))
        return self
    ...
    def deepcopy(self, **kwargs):
        ...
        for key in kwargs:
            if not hasattr(result, key):
                raise KeyError("Type Vector4d does not have attribute: " + str(key))
