...
class key_t(object):
    __slots__ = ["letter", "subscript", "superscript"]  # type: T.List[str]

    def __init__(
        self,
        letter=0,  # type: int
        subscript=0,  # type: int
        superscript=0,  # type: int
    ...
    @staticmethod
    def decode(data):
        # type: (T.Union[bytes, T.BinaryIO]) -> key_t
